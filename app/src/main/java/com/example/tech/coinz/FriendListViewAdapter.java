...
public class FriendListViewAdapter extends RecyclerView.Adapter<FriendListViewAdapter.ViewHolder>{
    ...
    public FriendListViewAdapter(ArrayList<String> userID, ArrayList<String> displayName, ArrayList<String> email, String coinID,  Context mContext) {
        this.userID = userID;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.friend_view_item, parent, false);
